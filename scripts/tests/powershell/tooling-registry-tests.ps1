...
$expectedPython = @(
    ...
    'scripts/test-gui-regression-runner.py'
    'scripts/test-gui-regression-evidence.py'
    'scripts/test-vm-automated-authority.py'
    'scripts/test-vm-automated-evidence.py'
    'scripts/test-vm-automated-state.py'
    'scripts/test-vm-automated-journal.py'
    'scripts/test-vm-automated-binding.py'
    'scripts/test-vm-automated-recovery.py'
    'scripts/test-vm-automated-platform.py'
    'scripts/test-vm-automated-campaign.py'
    'scripts/test-vm-automated-recovery-profile.py'
    'scripts/test-vm-automated-verifier.py'
    'scripts/test-vm-automated-menu-layout.py'
    'scripts/test-vm-automated-campaign-runner.py'
    'scripts/test-vm-automated-campaign-verifier.py'
    'scripts/test-vm-automated-cli.py'
)
