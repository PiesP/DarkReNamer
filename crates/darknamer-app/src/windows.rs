...
use windows_sys::Win32::UI::Controls::{
    ...
    TDF_POSITION_RELATIVE_TO_WINDOW, TDF_SIZE_TO_CONTENT, TDF_USE_COMMAND_LINKS, TTM_ACTIVATE,
    TTM_POP,
};
#[cfg(test)]
use windows_sys::Win32::UI::Controls::{
...
mod tests {
    ...
    fn verify_native_command_rails_at_dpi(
        ...
        let measured = measure_font_metrics(parent, message_font, status_font, dpi);
