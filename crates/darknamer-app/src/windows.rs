...
use windows_sys::Win32::UI::Controls::{
    ...
    HDI_WIDTH, HDITEMW, HDM_GETITEMW, HDN_ENDTRACKW, ICC_LISTVIEW_CLASSES, ICC_WIN95_CLASSES,
    ...
    LVM_DELETEALLITEMS, LVM_DELETEITEM, LVM_ENSUREVISIBLE, LVM_GETCOLUMNWIDTH, LVM_GETHEADER,
