...
The full MIT terms are available in that upstream repository. This project
retains the credit and uses the matched version as a compatibility reference;
the original executable itself is not tracked here.
